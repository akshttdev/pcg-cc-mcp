...
impl PythiaClient {
    ...
    ) -> Result<TaskSubmitResponse, PythiaClientError> {
    ...
    pub async fn get_task_status(
        &self,
        task_id: &str,
    ) -> Result<serde_json::Value, PythiaClientError> {
    ...
    pub async fn get_reputation(&self, wallet: &str) -> Result<NodeReputation, PythiaClientError> {
        let url = format!(
            "{}/api/economics/reputation?wallet={}",
    ...
    pub async fn estimate_cost(
        ...
        agent: &str,
        node_id: &str,
    ) -> Result<CostEstimate, PythiaClientError> {
        let url = format!(
