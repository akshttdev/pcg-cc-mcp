...
import type { PersonCompanyRole } from "./PersonCompanyRole";
import type { PersonOrgContact } from "./PersonOrgContact";
import type { PersonSocialProfile } from "./PersonSocialProfile";

/**
 * Rich view that joins social profiles alongside the person.
 */
export type PersonWithSocials = { social_profiles: Array<PersonSocialProfile>, company_roles: Array<PersonCompanyRole>, org_contacts: Array<PersonOrgContact>, id: string, full_name: string, email: string | null, phone: string | null, avatar_url: string | null, 
/**
