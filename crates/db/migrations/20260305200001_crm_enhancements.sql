...
-- 1. Multi-contact proposals  — contact_ids JSON array on proposals
-- 2. Structured multi-email/phone on persons  — emails/phones JSON arrays
-- 3. Rep assignment on persons  — assigned_to FK to users
...
CREATE INDEX idx_person_notes_proposal  ON person_notes(proposal_id);
