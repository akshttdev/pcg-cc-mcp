...
pub const DUCK_IMAGES_DIR: &str = ".duck-images";
...
pub fn get_duck_kanban_temp_dir() -> std::path::PathBuf {
    ...
    if cfg!(target_os = "macos") {
        ...
        // Windows and other platforms: use temp dir with duck-kanban subdirectory
        std::env::temp_dir().join(dir_name)
    }
}
...
mod tests {
    ...
    fn test_make_path_relative_macos_private_alias() {
        ...
        let worktree = "/var/folders/zz/abc123/T/duck-kanban-dev/worktrees/vk-test";
