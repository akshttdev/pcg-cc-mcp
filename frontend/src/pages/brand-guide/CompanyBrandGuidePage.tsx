...
import { Loader2, ArrowLeft, Instagram, Linkedin, Twitter, Facebook, Youtube, Printer, Palette, Pencil } from 'lucide-react';
        ...
        {company && companyId && (
          <>
            ...
            <BrandSetupWizard
              ...
              apiOverride={{
                upsert: (data: Partial<OrgBrandProfile>) => companiesApi.upsertBrandProfile(companyId, data),
                invalidateKey: ['companyBrandProfile', companyId],
              }}
            />
          </>
        )}
    ...
    <>
      <style>{`
        ...
        @media print {
          ...
          .print-page { min-height: 297mm; page-break-after: always; break-after: page; }
