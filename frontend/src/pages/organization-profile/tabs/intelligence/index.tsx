...
import { DataSourcesIntelView, ArtifactsIntelView } from './ArtifactsView';
...
export function IntelligenceTab({ projectEntries, orgId }: { projectEntries: { id: string; name: string }[]; orgId: string }) {
