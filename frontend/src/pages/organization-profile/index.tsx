...
const PipelinesTab = lazy(() => import('./tabs/PipelinesTab').then(m => ({ default: m.PipelinesTab })));
const ContactsTab = lazy(() => import('./tabs/ContactsTab').then(m => ({ default: m.ContactsTab })));
