...
const ProjectTasks = lazy(() =>
  import('@/pages/project-tasks').then((m) => ({ default: m.ProjectTasks }))
);
const ProjectControllerPage = lazy(() =>
  import('@/pages/project-controller').then((m) => ({
    default: m.ProjectControllerPage,
  }))
);
const MyTasksPage = lazy(() =>
  import('@/pages/my-tasks').then((m) => ({ default: m.MyTasksPage }))
);
...
const AgentProfilePage = lazy(() =>
  import('@/pages/agent-profile').then((m) => ({ default: m.AgentProfilePage }))
);
const GlobalTasksPage = lazy(() =>
  import('@/pages/global-tasks').then((m) => ({ default: m.GlobalTasksPage }))
);
const NoraPage = lazy(() =>
...
const CrmPage = lazy(() =>
  import('@/pages/crm').then((m) => ({ default: m.CrmPage }))
);
...
const OrganizationProfilePage = lazy(() =>
  import('@/pages/organization-profile').then((m) => ({
    default: m.OrganizationProfilePage,
  }))
);
const ClientOverview = lazy(() =>
  import('@/pages/client-overview').then((m) => ({ default: m.ClientOverview }))
);
const OrgClientsPage = lazy(() =>
  import('@/pages/org-clients').then((m) => ({ default: m.OrgClientsPage }))
);
const VirtualEnvironmentPage = lazy(() =>
  import('@/pages/virtual-environment').then((m) => ({
    default: m.VirtualEnvironmentPage,
  }))
);
const EmbedVirtualEnvironmentPage = lazy(() =>
  import('@/pages/embed/virtual-environment').then((m) => ({
    default: m.EmbedVirtualEnvironmentPage,
  }))
);
...
const AIUsagePage = lazy(() =>
  import('@/pages/ai-usage').then((m) => ({ default: m.AIUsagePage }))
);
const AgentExecutionsPage = lazy(() =>
  import('@/pages/agent-executions').then((m) => ({
    default: m.AgentExecutionsPage,
  }))
);
const OAuthCallbackPage = lazy(() =>
  import('@/pages/oauth/OAuthCallbackPage').then((m) => ({
...
const CompanyProfilePage = lazy(() =>
  import('@/pages/company-profile').then((m) => ({
    default: m.CompanyProfilePage,
  }))
);
const CompanyIntelPage = lazy(() =>
  import('@/pages/company-intel').then((m) => ({ default: m.CompanyIntelPage }))
);
const CommandCenterPage = lazy(() =>
  import('@/pages/command-center').then((m) => ({
...
const ProjectDeliverablesPage = lazy(() =>
  import('@/pages/project-deliverables').then((m) => ({
    default: m.ProjectDeliverablesPage,
  }))
);
const OrgDeliverablesPage = lazy(() =>
  import('@/pages/org-deliverables').then((m) => ({
    default: m.OrgDeliverablesPage,
  }))
);
...
const DataSourceDetailPage = lazy(() =>
  import('@/pages/data-source-detail').then((m) => ({
    default: m.DataSourceDetailPage,
  }))
);
const DiscordPage = lazy(() =>
  import('@/pages/discord').then((m) => ({ default: m.DiscordPage }))
);
const SiteDirectoryPage = lazy(() =>
  import('@/pages/site-directory').then((m) => ({
    default: m.SiteDirectoryPage,
  }))
);
const MediaLibraryPage = lazy(() =>
  import('@/pages/media-library').then((m) => ({ default: m.MediaLibraryPage }))
);
const ReviewPage = lazy(() =>
  import('@/pages/review').then((m) => ({ default: m.ReviewPage }))
);
const OssLibraryListenerPage = lazy(() =>
  import('@/pages/oss-library-listener').then((m) => ({
    default: m.OssLibraryListenerPage,
  }))
);
...
const ProfileSettings = lazy(() =>
  import('@/pages/settings/ProfileSettings').then((m) => ({
    default: m.ProfileSettings,
  }))
);
const UsersSettings = lazy(() =>
  import('@/pages/settings/UsersSettings').then((m) => ({
    default: m.UsersSettings,
  }))
);
const ProjectsSettings = lazy(() =>
  import('@/pages/settings/ProjectsSettings').then((m) => ({
    default: m.ProjectsSettings,
  }))
);
const OrganizationsSettings = lazy(() =>
  import('@/pages/settings/OrganizationsSettings').then((m) => ({
    default: m.OrganizationsSettings,
  }))
);
const PrivacySettings = lazy(() =>
  import('@/pages/settings/PrivacySettings').then((m) => ({
    default: m.PrivacySettings,
  }))
);
const ActivitySettings = lazy(() =>
  import('@/pages/settings/ActivitySettings').then((m) => ({
    default: m.ActivitySettings,
  }))
);
...
const ModelsSettings = lazy(() =>
  import('@/pages/settings/ModelsSettings').then((m) => ({
...
const WalletSettings = lazy(() =>
  import('@/pages/settings/WalletSettings').then((m) => ({
    default: m.WalletSettings,
  }))
);
const KeysSettings = lazy(() =>
  import('@/pages/settings/KeysSettings').then((m) => ({
    default: m.KeysSettings,
  }))
);
const NetworkSettings = lazy(() =>
  import('@/pages/settings/NetworkSettings').then((m) => ({
    default: m.NetworkSettings,
  }))
);
const DeveloperSettings = lazy(() =>
  import('@/pages/settings/DeveloperSettings').then((m) => ({
...
const TopsiUserSettingsPage = lazy(() =>
  import('@/pages/settings/TopsiUserSettings').then((m) => ({
    default: m.TopsiUserSettings,
  }))
);
const TopsiActivityPage = lazy(() =>
  import('@/pages/topsi-activity').then((m) => ({
...
const BrandGuidePage = lazy(() =>
  import('@/pages/brand-guide').then((m) => ({ default: m.BrandGuidePage }))
);
const CompanyBrandGuidePage = lazy(() =>
  import('@/pages/brand-guide/CompanyBrandGuidePage').then((m) => ({
    default: m.CompanyBrandGuidePage,
  }))
);
const CallIntakePage = lazy(() => import('@/pages/call-intake'));
const BusinessReportsPage = lazy(() => import('@/pages/business-reports'));
const ReportDetailPage = lazy(() =>
  import('@/pages/business-reports').then((m) => ({ default: m.ReportDetail }))
);
const PersonProfilePage = lazy(() =>
  import('@/pages/person-profile').then((m) => ({
    default: m.PersonProfilePage,
  }))
);
const PersonIntelPage = lazy(() =>
  import('@/pages/person-intel').then((m) => ({ default: m.PersonIntelPage }))
);
  ...
  return (
    <BrowserRouter>
      <SentryRoutes>
        ...
        <Route
          path="/embed/virtual-environment"
          element={
        ...
        >
          ...
          */}
          ...
          <Route
            ...
            element={
              <ProtectedRoute>
                <OrganizationProfilePage defaultTab="overview" />
              </ProtectedRoute>
            }
          />
          ...
          <Route
            ...
            element={
              <ProtectedRoute>
                <OrganizationProfilePage defaultTab="contacts" />
              </ProtectedRoute>
            }
          />
          <Route
          ...
          <Route
            ...
            element={
              <ProtectedRoute>
                <OrganizationProfilePage defaultTab="pipelines" />
              </ProtectedRoute>
            }
          />
          <Route
          ...
          <Route
            ...
            element={
              <ProtectedRoute>
                <OrganizationProfilePage defaultTab="social" />
              </ProtectedRoute>
            }
          />
          ...
          <Route
            ...
            element={
              <ProtectedRoute>
                <OrganizationProfilePage defaultTab="members" />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute>
                <OrganizationProfilePage defaultTab="projects" />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute>
                <OrganizationProfilePage defaultTab="integrations" />
              </ProtectedRoute>
            }
          />
          <Route
            ...
            element={
              <ProtectedRoute>
                <OrganizationProfilePage defaultTab="wiki" />
              </ProtectedRoute>
            }
          />
          ...
          <Route
            ...
            element={
              <RoleRoute minRole="platform_member">
                <MissionControlPage />
              </RoleRoute>
            }
          />
          ...
          <Route
            ...
            element={<PersonsRedirect suffix="/intel" />}
          />
          <Route
            path="/proposals"
            element={
          ...
          <Route
            ...
            element={
              <RoleRoute minRole="org_editor">
                <VirtualEnvironmentPage />
              </RoleRoute>
            }
          />
          <Route
            path="/mesh"
            element={<Navigate to="/settings/network" replace />}
          />
          <Route
            path="/pulse"
            element={
